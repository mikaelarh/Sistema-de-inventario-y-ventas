...
public class RestaurarBD extends javax.swing.JDialog {
    ...
    String bd = "poa";
    String path = "";
    String backup = "C:\\xampp\\mysql\\bin\\mysqldump.exe --user=" + user + " --password=" + password + " -v " + bd + " > " + path;
    Bd p;
    MySQL mysql;

    public RestaurarBD(Bd parent, boolean modal) {
        super(parent, modal);
        p = parent;
        initComponents();
        ...
        if (txtruta.getText().length() > 0) {
            try {
                ...
                if (c == JOptionPane.YES_OPTION) {
                    ...
                    mysql=new MySQL();
                    backup = "cmd /c C:\\xampp\\mysql\\bin\\mysql.exe --user=" + user + " --password=" + password + "   " + bd + " < " + path;
